# BMS FPL Trophy Cabinet

A quick historical record of league titles, cup titles, and season-level honors. The oldest seasons are only as complete as the manual history workbook, while 2024-25 and 2025-26 have much richer supporting data elsewhere on the site.

<details open>
<summary><h2>Major Trophy Count</h2></summary>

Use this table as the simple trophy cabinet: league titles plus BMS FPL Cup titles.
...
Use this as the audit trail for what fed the page.
...
- `season_honor_roll.csv`
- `major_trophies.csv`
- `history_source_audit.csv`
</details>
