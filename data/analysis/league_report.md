...
League `4365` through GW37. API game status: current_event `37`, next_event `38`, current_event_finished `True`.

Use the dropdown sections below to open or hide each metric.

## Best Quick Hits

- `**Cunha Believe it?!` has clinched first: 26-0-11, 78 H2H points, 1727 PF.
- The champion was also the raw scoring leader: 1727 PF, 46.7 per GW, and 4 weekly top-score weeks.
- The schedule/timing helped too: 1415 PA is the league's lowest, and the luck number is +15.0.
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | `**Cunha Believe it?!` | 26-0-11 | 78 | 1727 | 1415 | 46.7 | 4 | 2 |
| 2 | `Sue-nited FC*` | 23-0-14 | 69 | 1633 | 1609 | 44.1 | 7 | 3 |
| 3 | `Into the WOODwork*` | 21-2-14 | 65 | 1494 | 1420 | 40.4 | 3 | 2 |
| 4 | `Grand-Larseny` | 19-1-17 | 58 | 1612 | 1637 | 43.6 | 6 | 3 |
| 5 | `eze as u like b*%chs` | 19-0-18 | 57 | 1635 | 1543 | 44.2 | 6 | 4 |
| 6 | `Bowen Arrows` | 19-0-18 | 57 | 1540 | 1490 | 41.6 | 3 | 3 |
| 7 | `*Saka It To Me Baby` | 15-0-22 | 45 | 1449 | 1535 | 39.2 | 4 | 8 |
| 8 | `ChabosSpurs@Law` | 14-0-23 | 42 | 1450 | 1648 | 39.2 | 3 | 5 |
| 9 | `Santa’s reijnders` | 13-2-22 | 41 | 1477 | 1529 | 39.9 | 3 | 3 |
| 10 | `Amorim de mi vida` | 13-1-23 | 40 | 1430 | 1621 | 38.6 | 3 | 8 |
...
|---:|---|---:|---:|---:|---:|
| 1 | `Sue-nited FC*` | 65.7 | 69 | 1633 | 4.73 |
| 2 | `Grand-Larseny` | 63.4 | 58 | 1612 | 4.84 |
| 3 | `**Cunha Believe it?!` | 63.0 | 78 | 1727 | 4.78 |
| 4 | `eze as u like b*%chs` | 63.0 | 57 | 1635 | 4.95 |
| 5 | `Bowen Arrows` | 56.1 | 57 | 1540 | 5.27 |
| 6 | `Into the WOODwork*` | 52.9 | 65 | 1494 | 5.68 |
| 7 | `Santa’s reijnders` | 51.1 | 41 | 1477 | 5.95 |
| 8 | `ChabosSpurs@Law` | 48.3 | 42 | 1450 | 6.05 |
| 9 | `*Saka It To Me Baby` | 44.9 | 45 | 1449 | 6.27 |
| 10 | `Amorim de mi vida` | 42.7 | 40 | 1430 | 6.49 |
...
For `**Cunha Believe it?!`, that is `78 - 63.0 = +15.0`. The team still led the league in PF, but the schedule also broke nicely: low PA and several weeks where the opponent did not punish an ordinary score.

</details>

| Team | Actual H2H Pts | xPts | Luck | PA |
|---|---:|---:|---:|---:|
| `**Cunha Believe it?!` | 78 | 63.0 | +15.0 | 1415 |
| `Into the WOODwork*` | 65 | 52.9 | +12.1 | 1420 |
| `Sue-nited FC*` | 69 | 65.7 | +3.3 | 1609 |
| `Bowen Arrows` | 57 | 56.1 | +0.9 | 1490 |
| `*Saka It To Me Baby` | 45 | 44.9 | +0.1 | 1535 |
| `Amorim de mi vida` | 40 | 42.7 | -2.7 | 1621 |
| `Grand-Larseny` | 58 | 63.4 | -5.4 | 1637 |
| `eze as u like b*%chs` | 57 | 63.0 | -6.0 | 1543 |
| `ChabosSpurs@Law` | 42 | 48.3 | -6.3 | 1648 |
| `Santa’s reijnders` | 41 | 51.1 | -10.1 | 1529 |
...
Current holder after GW37: Ryan Donlan (`**Cunha Believe it?!`).
...
|---|---|---:|---:|---:|
| `eze as u like b*%chs` | Ryan Houseman | 6-3 | 51.6 | +9.7 |
| `Sue-nited FC*` | Justin Miller | 4-3 | 43.4 | -0.9 |
| `Amorim de mi vida` | Julius Long | 1-4 | 42.2 | +4.1 |
| `Grand-Larseny` | Drake Byrd | 8-5 | 42.1 | -2.2 |
| `**Cunha Believe it?!` | Ryan Donlan | 9-2 | 41.8 | -6.9 |
| `Santa’s reijnders` | Ethan Ellsworth | 2-7 | 38.7 | -1.6 |
| `*Saka It To Me Baby` | Levi Morant | 1-4 | 36.0 | -3.7 |
| `Bowen Arrows` | Dylan Reid | 2-3 | 33.6 | -9.3 |
| `ChabosSpurs@Law` | Alexander Chaban | 3-3 | 33.3 | -7.0 |
| `Into the WOODwork*` | Luke Lockwood | 1-3 | 32.2 | -9.1 |
...
<details class="notes">
<summary>eze as u like b*%chs: 7 bad beats, 2 soft wins</summary>
...
<details class="notes">
<summary>Bowen Arrows: 4 bad beats, 6 soft wins</summary>
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `**Cunha Believe it?!` | 46.7 | 44.0 | 15.4 | 103 | 20 | 4 | 2 |
| `Amorim de mi vida` | 38.6 | 38.0 | 12.9 | 75 | 18 | 3 | 8 |
| `eze as u like b*%chs` | 44.2 | 45.0 | 12.4 | 79 | 22 | 6 | 4 |
| `*Saka It To Me Baby` | 39.2 | 36.0 | 12.3 | 71 | 20 | 4 | 8 |
| `Grand-Larseny` | 43.6 | 44.0 | 12.2 | 64 | 16 | 6 | 3 |
| `Into the WOODwork*` | 40.4 | 40.0 | 11.7 | 60 | 21 | 3 | 2 |
| `ChabosSpurs@Law` | 39.2 | 36.0 | 11.4 | 59 | 18 | 3 | 5 |
| `Sue-nited FC*` | 44.1 | 45.0 | 11.2 | 70 | 22 | 7 | 3 |
| `Bowen Arrows` | 41.6 | 41.0 | 9.8 | 57 | 22 | 3 | 3 |
| `Santa’s reijnders` | 39.9 | 40.0 | 9.2 | 60 | 23 | 3 | 3 |
...
|---|---|---:|---:|---:|
| GKP | `**Cunha Believe it?!` | 164 | 37 | 4.43 |
| DEF | `eze as u like b*%chs` | 574 | 126 | 4.56 |
| MID | `Grand-Larseny` | 698 | 143 | 4.88 |
| FWD | `**Cunha Believe it?!` | 390 | 78 | 5.00 |
...
|---|---:|---:|---:|---:|
| `Sue-nited FC*` | 10 | 23 | 43.5% | 11.6 |
| `*Saka It To Me Baby` | 9 | 15 | 60.0% | 9.6 |
| `Into the WOODwork*` | 8 | 21 | 38.1% | 9.8 |
| `**Cunha Believe it?!` | 6 | 26 | 23.1% | 10.5 |
| `Amorim de mi vida` | 5 | 13 | 38.5% | 9.0 |
| `Grand-Larseny` | 4 | 19 | 21.1% | 7.2 |
| `Santa’s reijnders` | 3 | 13 | 23.1% | 14.3 |
| `eze as u like b*%chs` | 3 | 19 | 15.8% | 8.3 |
...
|---|---:|---:|---:|---:|
| `Bowen Arrows` | 8 | 18 | 44.4% | 5.4 |
| `eze as u like b*%chs` | 8 | 18 | 44.4% | 8.5 |
| `ChabosSpurs@Law` | 7 | 23 | 30.4% | 11.3 |
| `Santa’s reijnders` | 6 | 22 | 27.3% | 13.0 |
| `Amorim de mi vida` | 6 | 23 | 26.1% | 11.5 |
| `*Saka It To Me Baby` | 5 | 22 | 22.7% | 10.6 |
| `**Cunha Believe it?!` | 4 | 11 | 36.4% | 8.5 |
| `Grand-Larseny` | 4 | 17 | 23.5% | 16.0 |
| `Into the WOODwork*` | 2 | 14 | 14.3% | 13.0 |
